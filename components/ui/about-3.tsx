...
export const About3 = ({
  title = "About Us",
  description = "We are a passionate team dedicated to creating innovative solutions.",
  mainImage = {
  ...
  breakout = {
    ...
    description: "Providing real digital skills for real life in South Sudan.",
    buttonText: "Discover more",
    buttonUrl: "/sign-up",
  },
  companiesTitle = "Trusted by learners across South Sudan",
  companies = [],
  achievementsTitle = "Our Achievements in Numbers",
  achievementsDescription = "Empowering South Sudanese youth and entrepreneurs with practical digital skills.",
  achievements = [
  ...
  return (
    <section className="py-32">
      <div className="container mx-auto">
        ...
        <div className="relative mt-16 overflow-hidden rounded-xl bg-muted p-10 md:p-16">
